...
function AdminDashboard() {
    ...
    const renderContent = () => {
        ...
        if (showEditForm) {
            // ... (Keep existing form logic, though mostly redundant now for new signups, but good for backfill)
            return (
                                    ...
                                    <tbody>
                                        {pendingUsers.map(user => (
                                            <tr key={user.id}>
                                                ...
                                                <td>
                                                    <button onClick={() => handleApprove(user.id)} className="btn-primary" style={{ marginRight: '10px', fontSize: '0.8rem', padding: '6px 12px' }}>Approve</button>
                                                    <button onClick={() => handleReject(user.id)} className="btn-secondary" style={{ backgroundColor: '#dc3545', color: 'white', border: 'none', padding: '6px 12px', borderRadius: '6px', fontSize: '0.8rem', cursor: 'pointer' }}>Reject</button>
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
                    ...
                    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                        ...
                        <div className="table-card" style={{ marginBottom: '24px', display: 'flex', alignItems: 'center', gap: '24px' }}>
                            ...
                            <div>
                                ...
                                <span className="badge badge-gray" style={{ fontSize: '0.9rem' }}>Organization Admin</span>
                            </div>
                        </div>
