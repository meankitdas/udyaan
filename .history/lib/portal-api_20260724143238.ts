...
// Uses the same backend base URL env var as the rest of the main project so the
// portal is integrated with the main project's backend configuration.

export const API_BASE_URL = (process.env.NEXT_PUBLIC_UDYAAN_API ?? "http://localhost:8000").replace(/\/$/, "");
