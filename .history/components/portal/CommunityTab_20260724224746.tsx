  ...
  return (
    <div style={{ display: "grid", gap: "24px" }}>
      ...
      <div className="table-card">
        <h4 style={{ margin: "0 0 8px 0", color: "var(--dark-green)" }}>🧬 My Skills</h4>
      ...
      <div className="grid-2-cols">
        {/* Peer matches */}
        <div className="table-card">
          <h4 style={{ margin: "0 0 16px 0", color: "var(--dark-green)" }}>🤝 People You Should Meet</h4>
        ...
        {/* Project matches */}
        <div className="table-card">
          <h4 style={{ margin: "0 0 16px 0", color: "var(--dark-green)" }}>🎯 Projects That Need You</h4>
      ...
      {/* Leaderboard */}
      <div className="table-card">
        <h4 style={{ margin: "0 0 16px 0", color: "var(--dark-green)" }}>🏆 Org Leaderboard</h4>
