      ...
      <main>
        <section className="new-hero" aria-labelledby="hero-title">
          ...
          <div className="new-hero-copy">
            <p className="kicker">A 1,000-acre living lab for students</p>
            <h1 id="hero-title">Build what the<br />world needs <em>next.</em></h1>
            <p className="new-hero-description">
              Bring the question you cannot stop thinking about. At Udyaan, students from
              every discipline test it in the field, build the prototype, and take the
              strongest ideas toward market.
            </p>
            <div className="new-hero-actions">
              <Link className="round-button primary" href="#projects">Find your project <ArrowRightIcon /></Link>
              <Link className="text-link" href="#model">See how it works <span><ArrowDownIcon /></span></Link>
            </div>
            <div className="hero-proof" aria-label="Student journey">
              <div><strong>Field</strong><span>find the real problem</span></div>
              <div><strong>Lab</strong><span>make the idea work</span></div>
              <div><strong>Market</strong><span>prove that it matters</span></div>
            </div>
          </div>

          <div className="hero-visual hero-journal" aria-label="Students collaborating before taking their work into the field">
            <figure className="journal-main-image">
              <Image
                src="/udyaan-students.jpg"
                alt="A diverse group of university students developing ideas together"
                fill
                priority
                sizes="(max-width: 720px) 76vw, 58vw"
              />
            </figure>
            <div className="journal-headline">
              <span>Start with a question</span>
              <strong>Build it with people<br />who think differently.</strong>
            </div>
            <figure className="journal-field-image">
              <Image
                src="/udyaan-field-team.jpg"
                alt="A team working together across rows of crops"
                fill
                sizes="(max-width: 720px) 48vw, 24vw"
              />
              <figcaption><span>Then go outside</span><strong>Test it where it matters.</strong></figcaption>
            </figure>
            <div className="journal-path" aria-label="The Udyaan project path">
              <div><span>01</span><strong>Question</strong></div>
              <i aria-hidden="true" />
              <div><span>02</span><strong>Field test</strong></div>
              <i aria-hidden="true" />
              <div><span>03</span><strong>Proof</strong></div>
            </div>
            <p className="journal-credit">Photos: Andy Barbour + Tran Le Tuan / Pexels</p>
          </div>
        </section>
