    ...
    <div className="home-page">
      ...
      <main>
        <section className="cinematic-hero" aria-labelledby="hero-title">
          ...
          <p className="cinematic-credit">Film: Chàng Trai Nông Thôn / Pexels</p>
        </section>
        ...
        <section className="lab-section" id="lab" aria-labelledby="lab-title">
          ...
          <div className="lab-stage">
            <Image
              className="lab-media"
              src="/farmland-timelapse.webp"
              alt="Aerial view of the Udyaan campus and its connected systems"
              fill
              sizes="100vw"
              unoptimized
            />
            <div className="lab-media-veil" aria-hidden="true" />
            <ul className="lab-hotspots" aria-label="Living lab systems">
              <li className="lab-hotspot" style={{ top: "26%", left: "17%" }}>
                <span className="lab-hotspot-dot" aria-hidden="true" />
                <span className="lab-hotspot-tag"><b>01</b> Precision sensing</span>
              </li>
              <li className="lab-hotspot" style={{ top: "62%", left: "34%" }}>
                <span className="lab-hotspot-dot" aria-hidden="true" />
                <span className="lab-hotspot-tag"><b>02</b> Controlled cultivation</span>
              </li>
              <li className="lab-hotspot" style={{ top: "34%", left: "63%" }}>
                <span className="lab-hotspot-dot" aria-hidden="true" />
                <span className="lab-hotspot-tag"><b>03</b> Renewable operations</span>
              </li>
              <li className="lab-hotspot" style={{ top: "70%", left: "80%" }}>
                <span className="lab-hotspot-dot" aria-hidden="true" />
                <span className="lab-hotspot-tag"><b>04</b> Circular bioeconomy</span>
              </li>
            </ul>
