    ...
    <div className="home-page">
      ...
      <main>
        <section className="new-hero" aria-labelledby="hero-title">
          ...
          <div className="hero-visual" aria-label="Interactive 3D campus showing students moving an idea from field research to a market pilot">
            <span className="visual-label">Idea-to-impact system / Live model</span>
            <PlantScene />
            <div className="floating-note note-one">
              <span className="note-dot" />
              <div><small>Your role</small><strong>Co-founder of the solution</strong></div>
            </div>
          </div>
        </section>
